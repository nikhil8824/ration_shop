...
const EditProductScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await productsAPI.updateProduct(product._id, productData);
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <Title style={styles.headerTitle}>Edit Product</Title>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            {loading ? <ActivityIndicator color="#FFFFFF" /> : 'Update Product'}
          </Button>
        </View>
      </ScrollView>
    </SafeAreaView>
